            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <div class="flex flex-col justify-center items-center">
                    <form method="POST" action="{{ route('personas.update', $persona->id) }}" class="max-w-sm mx-auto">
                        ...
                        <div class="mb-5 py-2">
                            <button type="submit" class="bg-indigo-600 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline">
                                Actualizar
                            </button>
                            <a href="{{ route('personas.index') }}" class="mb-3 bg-green-600 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline">
                                Cancelar
                            </a>
                        </div>
                    </form>
